---
title: "QUESTION_1"
author: "Group 13 - Data Processes"
date: "15/12/2019"
...
draft <- drafts(draft_years = 2018:2018, return_message = T, nest_data = F)

player <- players_careers(players = draft$namePlayer, player_ids = draft$idPlayer, modes = c("PerGame", "Totals"), assign_to_environment = TRUE, add_mode_names = TRUE, return_message = TRUE)
